...
; Recebe algarismo hex (ASCII) pela UART e mostra no display de 7 seg.
; Invalido -> traco (-).  Botao (INT0) -> envia o nome pela UART.  4800 bps, 8N1
; Pinos: a..g -> PB0..PB6 (anodo comum, seg a = LSB) | botao -> PD2 | UART PD0/PD1
;==============================================================================
...
RESET:
    ...
    out  DDRB, AUX
    ldi  AUX, 0x3F       ; mostra '1' (catodo comum)
    out  PORTB, AUX
    ...
    ldi  AUX, 103           ; UBRR0 = 103 -> 4800 bps @ 8 MHz
    sts  UBRR0L, AUX
...
ISR_RX:
    push AUX
    in   AUX, SREG
    push AUX                ; salva SREG (forma dos slides)
